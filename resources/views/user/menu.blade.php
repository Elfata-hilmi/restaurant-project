        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Menu-Menu Terhebat</h1>
                </div>
                    ...
                    <ul class="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5">
                        ...
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 me-0 pb-3" data-bs-toggle="pill" href="#tab-3">
                                ...
                                <div class="ps-3">
                                    <small class="text-body">Pemadam</small>
                                    <h6 class="mt-n1 mb-0">Kehausan</h6>
                                </div>
                            </a>
                        </li>
                    </ul>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Ayam Geprek hytam </span>
                                                <span class="text-primary">$115</span>
                                            </h5>
                                            <small class="fst-italic">Ayam geprek dengan sambal hitam khas ngawi</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Hot Muani Chicken </span>
                                                <span class="text-primary">$115</span>
                                            </h5>
                                            <small class="fst-italic">Ayam renyah dengan sambel khas ngawi</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Pasta Saus Hytam</span>
                                                <span class="text-primary">$115</span>
                                            </h5>
                                            <small class="fst-italic">Pasta dengan resep dari italia aseli</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Ikan Bakar Bumbu PaK Hambali</span>
                                                <span class="text-primary">$115</span>
                                            </h5>
                                            <small class="fst-italic">Ikan dengan sensasi luar biasa nikmat</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Sayur Sop Kaki Biawak</span>
                                                <span class="text-primary">$115</span>
                                            </h5>
                                            <small class="fst-italic">Perpaduan antara sayur dan kaki biawak disatukan dalam sop</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Roti Susu KeNTaL Rusdi</span>
                                                <span class="text-primary">$115</span>
                                            </h5>
                                            <small class="fst-italic">Roti dengan susu kental manis ala Chef Rusdi</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Pizza Khas FesNuk</span>
                                                <span class="text-primary">$115</span>
                                            </h5>
                                            <small class="fst-italic">Pizza dengan saus hot rahasia yaitu FesNuk</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Bakso Sultan Terpesak</span>
                                                <span class="text-primary">$115</span>
                                            </h5>
                                            <small class="fst-italic">Bakso dekat samsat jalan sintang</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
